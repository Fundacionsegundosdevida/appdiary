...
const Register = () => {
  ...
  const onSubmit = async (e) => {
    ...
    if(nombre !== '' && correo !== '' && contraseña !== '' ) {
      ...
      setLoading(true);
      await axios
      .post('http://localhost:4091/register', Usuario )
      .then (({data}) => {
...
//<svg viewBox="0 0 30 24">
    //<path
    //  d="M27 0H3C1.35 0 0.15 1.35 0.015 3L0 21C0 22.65 1.35 24 3 24H27C28.65 24 30 22.65 30 21V3C30 1.3"
      //fill="black"
     ///>
//</svg>;
...
//<svg viewBox="0 0 30 30">
  //  <path
    //  d="M13.7474 23.7499C13.7488 23.7499 23.751 13.7499 23.7524V24.9999C13.7499 25.3314 13.6182"
      //fill="black"
      ///>
//</svg>;
